  ...
  return (
    <div className="bg-white p-4 md:p-6 rounded-lg shadow-md space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-500">Configure SMS delivery settings</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="md:col-span-1">
          ...
          <input
            type="password"
            defaultValue="support@medix"
            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black"
          />
        </div>
        <div className="md:col-span-1">
          <label className="block mb-1 text-sm font-semibold">Auth Token</label>
          <input
            type="password"
            defaultValue="support@m568"
            className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-black"
          />
        </div>
        <div className="md:col-span-2">
        ...
        <div className="md:col-span-1">
          <p className="text-md font-semibold py-4">SMS Testing</p>
          <label className="block mb-1 text-sm font-semibold">
            Test Phone Number
          </label>
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">

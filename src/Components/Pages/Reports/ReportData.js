...
export const ReportData = {
  ...
  patientReport: {
    ...
    TopConditionPieChart: [
      { name: "Diabetes", value: 46, color: "#0088FE" },
      { name: "Respiratory Infections", value: 20, color: "#82CA9D" },
      { name: "Hypertension", value: 24, color: "#FFBB28" },
      { name: "Cardiovascular", value: 10, color: "#FF8042" },

...
import PatientVisitReportCard from "./PatientReportCard/PatientVisitReportCard";
import PatientReportTab from "./PatientReeportTab/PatientReportTab";
  ...
  return (
    <div className="p-5">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-y-4">
        <div>
          <p className="text-3xl font-semibold">Patient Visit Report</p>

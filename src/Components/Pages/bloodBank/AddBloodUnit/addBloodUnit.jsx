            ...
            <div className="mx-auto p-6">
                <div className='flex justify-between items-center mb-6'>
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Add a new blood unit to the blood bank inventory</p>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div className="p-6">
                        <h2 className="text-lg font-medium text-gray-900 mb-2">Blood Unit Information</h2>
                        <p className="text-sm text-gray-600 mb-6">Enter the details of the new blood unit to be added to the inventory.</p>

  ...
  return (
    <div className="p-4 border border-gray-300 rounded-lg w-full">
      <div className="flex items-center justify-between">
        <p className="text-lg font-semibold">Medication #1</p>

        <Button variant="primary" text="" Icon={RiDeleteBin7Line} className="text-red-500"/>
      </div>
...
export default FirstMedication;
